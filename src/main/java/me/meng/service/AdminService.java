...
public class AdminService {
    ...
    public Account createAccount(String name, double startingBalance, String type, String cardNumber, String pin)
    ...
    public String describeAccount(Account acc) {
        ...
        return acc.getAccountNumber() + " | " + acc.getName() + " | " + acc.getAccountType()
